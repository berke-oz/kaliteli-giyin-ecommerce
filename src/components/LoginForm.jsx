            ...
            <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-6">
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="text-muted-foreground">Hesabın ile giriş yap</p>
                    </div>
                    ...
                    <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border">
                        <span className="relative z-10 bg-white px-2 text-muted-foreground">Diğer hesaplarla giriş</span>
                    </div>
                    <div className="grid grid-cols-3 gap-4">
                        <button type="button" className="w-full border border-gray-300 rounded-md py-2 hover:bg-gray-100">
